...
if __name__ == "__main__":
    ...
    parser.add_argument("--target", type=str, default="Behind_11", help="target feature in S or MS task")
    ...
    parser.add_argument('--patch_num', type=int, default=16, help='patch number')
    ...
    parser.add_argument('--kernel_size', type=int, default=2, help='decomposition-kernel')
    ...
    # DiPE
    parser.add_argument('--num_experts', type=int, default=16, help='number of experts for DiPE')
    parser.add_argument('--loss_alpha', type=float, default=0.5, help='loss alpha for DiPE')
    ...
    # TCN
    parser.add_argument('--num_channels', type=int, default=[64, 128, 256], help='num of channels for TCN')
    # parser.add_argument('--kernel_size', type=int, default=2, help='kernel size for TCN')
