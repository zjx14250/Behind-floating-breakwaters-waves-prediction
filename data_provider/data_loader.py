...
class Dataset_Waveheight(Dataset):
    def __init__(
        self,
        args,
        root_path,
    ...
    def __read_data__(self):
        ...
        if self.scale:
            if self.args.fanhua and self.flag == 'test':

                scaler_params = np.load('./checkpoints/scaler_params.npz')
                self.scaler = StandardScaler()
        ...
        if self.args.fanhua and self.flag == 'test':
            self.data_x = data[0:2000]
            self.data_y = data[0:2000]
        else:
            self.data_x = data[border1:border2]
            self.data_y = data[border1:border2]
...
class Dataset_Waveheight_Cycle(Dataset):
    def __init__(
        self,
        args,
        root_path,
...
class Dataset_Waveheight_copy(Dataset):
    def __init__(
        self,
        args,
        root_path,
